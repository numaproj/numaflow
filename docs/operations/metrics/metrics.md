...
| `controller_isbsvc_health`        | Gauge       | `ns=<namespace>` <br> `isbsvc=<isbsvc-name>`                                                                                                                  | A metric to indicate whether the Pipeline is healthy. '1' means healthy, '0' means unhealthy   |

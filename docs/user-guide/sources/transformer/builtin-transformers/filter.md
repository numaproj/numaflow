# Filter [Deprecated]
  ...
  > ⚠️ Note: Builtins for transformer are deprecated. An example in Go for filter can be found [here.](https://github.com/numaproj/numaflow-go/tree/main/pkg/sourcetransformer/examples/filter) 

...
func (s *SideInputSuite) TestSimpleSideInputPipeline() {
	...
	w.Expect().SinkContains("sink", "odd-data", fixtures.WithTimeout(2*time.Minute))
	w.Expect().SinkContains("sink", "even-data", fixtures.WithTimeout(2*time.Minute))

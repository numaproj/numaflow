...
func (s *SideInputSuite) TestSimpleMapSideInputPipeline() {
	...
	pipelineName := "sideinput-pipeline"
	...
	// some_value message is generated by mapper function
	w.Expect().SinkContains("sink", "some_value")

	// odd-data and even-data message is generated by side input
	w.Expect().SinkContains("sink", "odd-data")
	w.Expect().SinkContains("sink", "even-data")
...
func (s *SideInputSuite) TestSimpleReduceSideInputPipeline() {
	...
	// here side-input-data text is generated by side input and stored in sinker via reducer.
	w.Expect().SinkContains("sink", "side-input-data")

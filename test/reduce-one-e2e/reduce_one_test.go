...
func (r *ReduceSuite) TestSimpleKeyedReducePipeline() {
	...
	w.Expect().
		RedisSinkContains("sink", "40").
		RedisSinkContains("sink", "20")
	done <- struct{}{}
}
...
func (r *ReduceSuite) TestSimpleNonKeyedReducePipeline() {
	...
	w.Expect().RedisSinkContains("sink", "60")
	done <- struct{}{}
}
...
func (r *ReduceSuite) TestComplexReducePipelineKeyedNonKeyed() {
	...
	w.Expect().RedisSinkContains("sink", "180")
	done <- struct{}{}
}
...
func (r *ReduceSuite) TestSimpleReducePipelineFailOverUsingWAL() {
	...
	w.Expect().
		RedisSinkContains("sink", "38").
		RedisSinkContains("sink", "76").
		RedisSinkContains("sink", "120").
		RedisSinkContains("sink", "240")

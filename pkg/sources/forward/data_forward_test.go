...
func TestNewDataForward(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name+"_basic", func(t *testing.T) {
			...
			f, err := NewDataForward(vertexInstance, fromStep, toSteps, &mySourceForwardTestRoundRobin{}, myForwardTest{}, fetchWatermark, TestSourceWatermarkPublisher{}, noOpStores, wmb.NewSingleIdleManager(len(toSteps)), WithReadBatchSize(batchSize))
		...
		t.Run(tt.name+"_toAll", func(t *testing.T) {
			...
			f, err := NewDataForward(vertexInstance, fromStep, toSteps, &myForwardToAllTest{}, &myForwardToAllTest{}, fetchWatermark, TestSourceWatermarkPublisher{}, toVertexStores, wmb.NewSingleIdleManager(len(toSteps)), WithReadBatchSize(batchSize))
		...
		t.Run(tt.name+"_dropAll", func(t *testing.T) {
			...
			f, err := NewDataForward(vertexInstance, fromStep, toSteps, myForwardDropTest{}, myForwardDropTest{}, fetchWatermark, TestSourceWatermarkPublisher{}, toVertexStores, wmb.NewSingleIdleManager(len(toSteps)), WithReadBatchSize(batchSize))
		...
		t.Run(tt.name+"_toOneStep", func(t *testing.T) {
			...
			f, err := NewDataForward(vertexInstance, fromStep, toSteps, &mySourceForwardTestRoundRobin{}, myForwardTest{}, fetchWatermark, TestSourceWatermarkPublisher{}, toVertexStores, wmb.NewSingleIdleManager(len(toSteps)), WithReadBatchSize(batchSize))
		...
		t.Run(tt.name+"_TransformerError", func(t *testing.T) {
			...
			f, err := NewDataForward(vertexInstance, fromStep, toSteps, myForwardApplyTransformerErrTest{}, myForwardApplyTransformerErrTest{}, fetchWatermark, TestSourceWatermarkPublisher{}, toVertexStores, wmb.NewSingleIdleManager(len(toSteps)), WithReadBatchSize(batchSize))
		...
		t.Run(tt.name+"_whereToError", func(t *testing.T) {
			...
			fetchWatermark, _ := generic.BuildNoOpSourceWatermarkProgressorsFromBufferMap(toSteps)
			toVertexStores := buildNoOpToVertexStores(toSteps)
			f, err := NewDataForward(vertexInstance, fromStep, toSteps, myForwardApplyWhereToErrTest{}, myForwardApplyWhereToErrTest{}, fetchWatermark, TestSourceWatermarkPublisher{}, toVertexStores, wmb.NewSingleIdleManager(len(toSteps)), WithReadBatchSize(batchSize))
		...
		t.Run(tt.name+"_withInternalError", func(t *testing.T) {
			...
			fetchWatermark, _ := generic.BuildNoOpSourceWatermarkProgressorsFromBufferMap(toSteps)
			toVertexStores := buildNoOpToVertexStores(toSteps)
			f, err := NewDataForward(vertexInstance, fromStep, toSteps, myForwardInternalErrTest{}, myForwardInternalErrTest{}, fetchWatermark, TestSourceWatermarkPublisher{}, toVertexStores, wmb.NewSingleIdleManager(len(toSteps)), WithReadBatchSize(batchSize))
...
func TestDataForwardSinglePartition(t *testing.T) {
	...
	f, err := NewDataForward(vertexInstance, fromStep, toSteps, mySourceForwardTest{}, mySourceForwardTest{}, fetchWatermark, TestSourceWatermarkPublisher{}, toVertexStores, wmb.NewSingleIdleManager(len(toSteps)), WithReadBatchSize(5))
	assert.NoError(t, err)
	assert.False(t, to1.IsFull())
	assert.True(t, to1.IsEmpty())
...
func TestDataForwardMultiplePartition(t *testing.T) {
	...
	f, err := NewDataForward(vertexInstance, fromStep, toSteps, &mySourceForwardTestRoundRobin{}, mySourceForwardTest{}, fetchWatermark, TestSourceWatermarkPublisher{}, toVertexStores, wmb.NewSingleIdleManager(len(toSteps)), WithReadBatchSize(5))
	assert.NoError(t, err)
	assert.False(t, to11.IsFull())
	assert.False(t, to12.IsFull())
	assert.True(t, to11.IsEmpty())
...
func TestWriteToBuffer(t *testing.T) {
	...
	for _, value := range tests {
		t.Run(value.name, func(t *testing.T) {
			...
			fetchWatermark, _ := generic.BuildNoOpSourceWatermarkProgressorsFromBufferMap(toSteps)
			toVertexStores := buildNoOpToVertexStores(toSteps)
			f, err := NewDataForward(vertexInstance, fromStep, toSteps, myForwardTest{}, myForwardTest{}, fetchWatermark, TestSourceWatermarkPublisher{}, toVertexStores, wmb.NewSingleIdleManager(len(toSteps)), WithReadBatchSize(value.batchSize))
			assert.NoError(t, err)

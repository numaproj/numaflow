...
func TestMessageHandling(t *testing.T) {
	...
	ks, _ := NewKafkaSource(vi, toBuffers, myForwardToAllTest{}, applier.Terminal, fetchWatermark, toVertexWmStores, publishWMStore, wmb.NewSingleIdleManager(len(toBuffers)), WithLogger(logging.NewLogger()),

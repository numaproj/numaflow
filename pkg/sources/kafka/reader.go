...
func NewKafkaSource(
	...
	forwarder, err := forward.NewInterStepDataForward(vertexInstance.Vertex, kafkasource, writers, fsd, mapApplier, fetchWM, publishWM, toVertexPartitionMap, forwardOpts...)
	if err != nil {

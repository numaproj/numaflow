...
import (
	...
	"github.com/numaproj/numaflow/pkg/sdkclient/sideinput/clienttest"
...
func NewMockUDSgRPCBasedUDSideinput(mockClient *sideinputmock.MockUserDefinedSideInputClient) *UDSgRPCBasedUDSideinput {
...
func Test_gRPCBasedUDSideInput_WaitUntilReadyWithMockClient(t *testing.T) {
	...
	mockClient := sideinputmock.NewMockUserDefinedSideInputClient(ctrl)
...
func Test_gRPCBasedUDSideInput_ApplyWithMockClient(t *testing.T) {
	t.Run("test success", func(t *testing.T) {
		...
		mockSideInputClient := sideinputmock.NewMockUserDefinedSideInputClient(ctrl)

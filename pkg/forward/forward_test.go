...
func (f myForwardTest) WhereTo(_ []string, i []string) ([]string, error) {
...
func (f mySourceForwardTest) WhereTo(_ []string, i []string) ([]string, error) {
	return []string{"to1"}, nil
}
...
func (f myForwardDropTest) WhereTo(_ []string, i []string) ([]string, error) {
	return []string{}, nil
}
...
func (f myForwardToAllTest) WhereTo(_ []string, i []string) ([]string, error) {
...
func (f myForwardInternalErrTest) WhereTo(_ []string, i []string) ([]string, error) {
	return []string{"to1"}, nil
}
...
func (f myForwardApplyWhereToErrTest) WhereTo(_ []string, i []string) ([]string, error) {
...
func (f myForwardApplyUDFErrTest) WhereTo(_ []string, i []string) ([]string, error) {
	return []string{"to1"}, nil
}

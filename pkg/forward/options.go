...
type options struct {
	...
	readBatchSize int64
	// udfConcurrency sets the concurrency for concurrent mapUDF processing
	udfConcurrency int
	...
	// enableMapUdfStream indicates whether the message streaming is enabled or not for mapUDF processing
...
// WithUDFConcurrency sets concurrency for mapUDF processing
...
// WithUDFStreaming sets streaming for mapUDF processing

...
//
//	udfcall "github.com/numaproj/numaflow/pkg/reduceApplier/rpc"
//
...
//	pf := newProcessAndForward(ctx, "reduce", "test-pipeline", 0, testPartition, client, simplePbq, make(map[string][]isb.BufferWriter, 1), &forwardTest{}, publishWatermark, wmb.NewIdleManager(1), pbqManager)
//
//	err = pf.Process(ctx)
//	assert.NoError(t, err)
...
//			pf.writeToBuffer(ctx, "buffer", 0, writeMessages)
//		})
//	}
//}
//

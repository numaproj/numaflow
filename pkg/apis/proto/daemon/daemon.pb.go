...
type VertexMetrics struct {
	...
	ProcessingRate       *string  `protobuf:"bytes,5,opt,name=processingRate" json:"processingRate,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *VertexMetrics) GetProcessingRate() string {
	if m != nil && m.ProcessingRate != nil {
...
var fileDescriptor_93e327fd0d673221 = []byte{
	...
	,
}
...
func (m *VertexMetrics) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ProcessingRate != nil {
		i -= len(*m.ProcessingRate)
		copy(dAtA[i:], *m.ProcessingRate)
		i = encodeVarintDaemon(dAtA, i, uint64(len(*m.ProcessingRate)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Pendings) > 0 {

...
type GetVertexMetricsRequest struct {
	...
	Pods                 *int64   `protobuf:"varint,4,req,name=pods" json:"pods,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetVertexMetricsRequest) GetPods() int64 {
	if m != nil && m.Pods != nil {
		return *m.Pods
	}
	return 0
...
type GetVertexMetricsResponse struct {
	...
	PodMetrics           []*VertexMetrics `protobuf:"bytes,2,rep,name=podMetrics" json:"podMetrics,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *GetVertexMetricsResponse) GetPodMetrics() []*VertexMetrics {
	if m != nil {
		return m.PodMetrics
	}
	return nil
...
type VertexWatermark struct {
	...
	PodWatermarks        []int64  `protobuf:"varint,5,rep,name=podWatermarks" json:"podWatermarks,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *VertexWatermark) GetPodWatermarks() []int64 {
	if m != nil {
...
var fileDescriptor_93e327fd0d673221 = []byte{
	...
	,
}
...
func (m *GetVertexMetricsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Pods == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("pods")
	} else {
		i = encodeVarintDaemon(dAtA, i, uint64(*m.Pods))
		i--
		dAtA[i] = 0x20
	}
	if m.Vertex == nil {
...
func (m *VertexWatermark) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PodWatermarks) > 0 {
		for iNdEx := len(m.PodWatermarks) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintDaemon(dAtA, i, uint64(m.PodWatermarks[iNdEx]))
			i--
			dAtA[i] = 0x28
		}
	}
...
func (m *GetVertexMetricsRequest) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000004) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("pods")
	}
...
func (m *GetVertexMetricsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.PodMetrics = append(m.PodMetrics, &VertexMetrics{})
	...
	for iNdEx < l {
		...
		case 5:
			if wireType == 0 {
				...
				m.PodWatermarks = append(m.PodWatermarks, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.PodWatermarks) == 0 {
					m.PodWatermarks = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field PodWatermarks", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipDaemon(dAtA[iNdEx:])

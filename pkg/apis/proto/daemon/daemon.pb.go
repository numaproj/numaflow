...
func (x *ContainerError) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
var file_pkg_apis_proto_daemon_daemon_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x22, 0x4c, 0x0a,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x76, 0x65, 0x72, 0x74, 0x65, 0x78, 0x22, 0x94, 0x01, 0x0a, 0x0e,
	0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x1c,
	0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x09, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x1c, 0x0a, 0x09,
...
var file_pkg_apis_proto_daemon_daemon_proto_depIdxs = []int32{
	...
	15, // 16: daemon.ReplicaErrors.containerErrors:type_name -> daemon.ContainerError
	16, // 17: daemon.GetVertexErrorsResponse.errors:type_name -> daemon.ReplicaErrors
	21, // 18: daemon.VertexMetrics.ProcessingRatesEntry.value:type_name -> google.protobuf.DoubleValue
	20, // 19: daemon.VertexMetrics.PendingsEntry.value:type_name -> google.protobuf.Int64Value
	3,  // 20: daemon.DaemonService.ListBuffers:input_type -> daemon.ListBuffersRequest
	5,  // 21: daemon.DaemonService.GetBuffer:input_type -> daemon.GetBufferRequest
	9,  // 22: daemon.DaemonService.GetVertexMetrics:input_type -> daemon.GetVertexMetricsRequest
	13, // 23: daemon.DaemonService.GetPipelineWatermarks:input_type -> daemon.GetPipelineWatermarksRequest
	7,  // 24: daemon.DaemonService.GetPipelineStatus:input_type -> daemon.GetPipelineStatusRequest
	14, // 25: daemon.DaemonService.GetVertexErrors:input_type -> daemon.GetVertexErrorsRequest
	4,  // 26: daemon.DaemonService.ListBuffers:output_type -> daemon.ListBuffersResponse
	6,  // 27: daemon.DaemonService.GetBuffer:output_type -> daemon.GetBufferResponse
	10, // 28: daemon.DaemonService.GetVertexMetrics:output_type -> daemon.GetVertexMetricsResponse
	12, // 29: daemon.DaemonService.GetPipelineWatermarks:output_type -> daemon.GetPipelineWatermarksResponse
	8,  // 30: daemon.DaemonService.GetPipelineStatus:output_type -> daemon.GetPipelineStatusResponse
	17, // 31: daemon.DaemonService.GetVertexErrors:output_type -> daemon.GetVertexErrorsResponse

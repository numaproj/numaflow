...
type VertexMetrics struct {
	...
	// Processing rate of the entire vertex.
	VertexProcessingRates map[string]float64 `protobuf:"bytes,5,rep,name=vertexProcessingRates" json:"vertexProcessingRates,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"fixed64,2,opt,name=value"`
	XXX_NoUnkeyedLiteral  struct{}           `json:"-"`
	XXX_unrecognized      []byte             `json:"-"`
	XXX_sizecache         int32              `json:"-"`
}
...
func (m *VertexMetrics) GetVertexProcessingRates() map[string]float64 {
	if m != nil {
		return m.VertexProcessingRates
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[string]float64)(nil), "daemon.VertexMetrics.VertexProcessingRatesEntry")
...
var fileDescriptor_93e327fd0d673221 = []byte{
	...
	,
}
...
func (m *VertexMetrics) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.VertexProcessingRates) > 0 {
		for k := range m.VertexProcessingRates {
			v := m.VertexProcessingRates[k]
			baseI := i
			i -= 8
...
func (m *VertexMetrics) Size() (n int) {
	...
	if len(m.VertexProcessingRates) > 0 {
		for k, v := range m.VertexProcessingRates {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovDaemon(uint64(len(k))) + 1 + 8
			n += mapEntrySize + 1 + sovDaemon(uint64(mapEntrySize))
...
func (m *VertexMetrics) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VertexProcessingRates", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.VertexProcessingRates == nil {
				m.VertexProcessingRates = make(map[string]float64)
			}
			var mapkey string
			var mapvalue float64
			for iNdEx < postIndex {
			...
			m.VertexProcessingRates[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDaemon(dAtA[iNdEx:])

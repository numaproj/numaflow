...
var file_pkg_apis_proto_isb_message_proto_goTypes = []interface{}{
...
func file_pkg_apis_proto_isb_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_apis_proto_isb_message_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_apis_proto_isb_message_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_apis_proto_isb_message_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Header); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pkg_apis_proto_isb_message_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_apis_proto_isb_message_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Body); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pkg_apis_proto_isb_message_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_apis_proto_isb_message_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_apis_proto_isb_message_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {

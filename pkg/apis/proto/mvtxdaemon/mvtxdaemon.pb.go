...
func file_pkg_apis_proto_mvtxdaemon_mvtxdaemon_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_apis_proto_mvtxdaemon_mvtxdaemon_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*GetMonoVertexErrorsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_apis_proto_mvtxdaemon_mvtxdaemon_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_pkg_apis_proto_mvtxdaemon_mvtxdaemon_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_pkg_apis_proto_mvtxdaemon_mvtxdaemon_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*GetMonoVertexErrorsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

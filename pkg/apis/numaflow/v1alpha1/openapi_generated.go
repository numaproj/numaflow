		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"desiredPhase": {
						SchemaProps: spec.SchemaProps{
							Description: "// DeleteGracePeriodSeconds used to delete a MonoVertex gracefully // +kubebuilder:default=30 // +optional DeleteGracePeriodSeconds *int32 `json:\"deleteGracePeriodSeconds,omitempty\" protobuf:\"varint,1,opt,name=deleteGracePeriodSeconds\"` DesiredPhase used to bring the pipeline from current phase to desired phase",
							Type:        []string{"string"},
							Format:      "",
						},
					},

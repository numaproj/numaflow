...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SASLSCRAMSHA) DeepCopyInto(out *SASLSCRAMSHA) {
	*out = *in
	if in.UserSecret != nil {
		in, out := &in.UserSecret, &out.UserSecret
		*out = new(v1.SecretKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SASLSCRAMSHA.
func (in *SASLSCRAMSHA) DeepCopy() *SASLSCRAMSHA {
	if in == nil {
		return nil
	}
	out := new(SASLSCRAMSHA)

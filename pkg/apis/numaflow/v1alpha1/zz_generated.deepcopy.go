...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeprecatedEdgeLimits) DeepCopyInto(out *DeprecatedEdgeLimits) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeprecatedEdgeLimits.
func (in *DeprecatedEdgeLimits) DeepCopy() *DeprecatedEdgeLimits {
	if in == nil {
		return nil
	}
	out := new(DeprecatedEdgeLimits)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Edge) DeepCopyInto(out *Edge) {
	*out = *in
	...
	if in.DeprecatedLimits != nil {
		in, out := &in.DeprecatedLimits, &out.DeprecatedLimits
		*out = new(DeprecatedEdgeLimits)
		(*in).DeepCopyInto(*out)
	}
	if in.DeprecatedParallelism != nil {
		in, out := &in.DeprecatedParallelism, &out.DeprecatedParallelism
		*out = new(int32)
		**out = **in
	}
	if in.OnFull != nil {

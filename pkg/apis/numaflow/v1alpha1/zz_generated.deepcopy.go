...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BuiltInServingStore) DeepCopyInto(out *BuiltInServingStore) {
	*out = *in
	if in.URL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BuiltInServingStore.
func (in *BuiltInServingStore) DeepCopy() *BuiltInServingStore {
	if in == nil {
		return nil
	}
	out := new(BuiltInServingStore)
	in.DeepCopyInto(out)
	return out
}

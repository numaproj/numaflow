...
func TestNewInterStepDataForward(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name+"_basic", func(t *testing.T) {
			...
			if tt.mapEnabled {
				opts = append(opts, WithUDFMap(myForwardTest{}))
			}
		...
		t.Run(tt.name+"_toAll", func(t *testing.T) {
			...
			if tt.mapEnabled {
				opts = append(opts, WithUDFMap(&myForwardToAllTest{}))
			}
		...
		t.Run(tt.name+"_dropAll", func(t *testing.T) {
			...
			if tt.mapEnabled {
				opts = append(opts, WithUDFMap(myForwardDropTest{}))
			}
		...
		t.Run(tt.name+"_UDFError", func(t *testing.T) {
			...
			if tt.mapEnabled {
				opts = append(opts, WithUDFMap(myForwardApplyUDFErrTest{}))
			}
		...
		t.Run(tt.name+"_whereToError", func(t *testing.T) {
			...
			if tt.mapEnabled {
				opts = append(opts, WithUDFMap(myForwardApplyWhereToErrTest{}))
			}
		...
		t.Run(tt.name+"_withInternalError", func(t *testing.T) {
			...
			if tt.mapEnabled {
				opts = append(opts, WithUDFMap(myForwardInternalErrTest{}))
			}
...
func TestNewInterStepDataForwardIdleWatermark(t *testing.T) {
	...
	opts := []Option{WithReadBatchSize(2), WithUDFMap(myForwardTest{})}
...
func TestInterStepDataForwardSinglePartition(t *testing.T) {
	...
	opts := []Option{WithReadBatchSize(5), WithUDFMap(mySourceForwardTest{})}

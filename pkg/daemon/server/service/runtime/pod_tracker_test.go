...
func TestPodTracker_Start(t *testing.T) {
	...
	assert.Equal(t, 10, pt.GetActivePodsCountForVertex("v"))
}
...
func TestPodTracker_updateActivePods(t *testing.T) {
	...
	assert.Equal(t, 3, pt.GetActivePodsCountForVertex("v"))
}
...
func TestPodTrackerResolverFailureIsIsolatedByVertex(t *testing.T) {
	...
	assert.Equal(t, 3, pt.GetActivePodsCountForVertex("v"))
	assert.Equal(t, 0, pt.GetActivePodsCountForVertex("other"))
}
...
func TestRuntimeCacheFetchesContiguousReplicas(t *testing.T) {
	...
	tracker.setActivePodsCount("v", 3)
	...
	assert.ElementsMatch(t, []string{
		...
		"https://p-v-1.p-v-headless.default.svc:2470/runtime/errors",

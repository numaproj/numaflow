...
func TestNewDataForward(t *testing.T) {
	...
	t.Run(testName+"_basic", func(t *testing.T) {
		...
		f, err := NewDataForward(vertexInstance, fromStep, to1, fetchWatermark, publishWatermark[testVertexName], wmb.NewSingleIdleManager(1))
...
func TestWriteToBuffer(t *testing.T) {
	...
	for _, value := range tests {
		t.Run(value.name, func(t *testing.T) {
			...
			f, err := NewDataForward(vertexInstance, fromStep, buffer, fetchWatermark, publishWatermark["to1"], wmb.NewSingleIdleManager(1))

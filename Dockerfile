...
COPY --from=extension-base /usr/share/zoneinfo /usr/share/zoneinfo
COPY --from=extension-base /etc/ssl/certs/ca-certificates.crt /etc/ssl/certs/ca-certificates.crt

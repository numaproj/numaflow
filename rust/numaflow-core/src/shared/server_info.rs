...
mod version {
    ...
    static MINIMUM_SUPPORTED_SDK_VERSIONS: LazyLock<SdkConstraints> = LazyLock::new(|| {
        ...
        rust_version_map.insert("sourcer".to_string(), "0.1.1-z".to_string());
        rust_version_map.insert("sourcetransformer".to_string(), "0.1.1-z".to_string());
        rust_version_map.insert("sinker".to_string(), "0.1.1-z".to_string());
        rust_version_map.insert("fb-sinker".to_string(), "0.1.1-z".to_string());

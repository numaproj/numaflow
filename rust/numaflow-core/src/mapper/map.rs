//! The `MapHandle` orchestrates reading messages from the input stream, invoking the map operation,
...
//! ```
//!
//! The `MapHandle` reads messages from the input stream and invokes the map operation based on the mode:

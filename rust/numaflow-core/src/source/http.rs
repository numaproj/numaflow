...
mod tests {
    ...
    async fn test_core_http_source() {
        ...
        assert_eq!(partitions.active_partitions.len(), 1, "Should have 1 partition");
        assert!(partitions.total_partitions.is_none(), "HTTP source should not have total_partitions");

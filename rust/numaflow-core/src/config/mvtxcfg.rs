pub(crate) mod monovertex {
    use crate::config::common::sink::{OnFailureStrategy, RetryConfig, SinkConfig};
    use crate::config::common::source::{GeneratorConfig, SourceConfig};
    use crate::config::common::transformer::{
        TransformerConfig, TransformerType, UserDefinedConfig,
    };
    use crate::config::common::Metrics::MetricsConfig;
    use crate::config::common::{sink, source};
    ...
    impl MonovertexConfig {
        pub fn load(mono_vertex_spec: String) -> Result<Self> {
                    ...
                    sink.udsink
                        ...
                        .map(|_| SinkConfig {
                            sink_type: sink::SinkType::UserDefined(
                                sink::UserDefinedConfig::default(),
                            ),
                        ...
                        .or_else(|| {
                            sink.blackhole.as_ref().map(|_| SinkConfig {
                                sink_type: sink::SinkType::Blackhole(
                                    sink::BlackholeConfig::default(),
                                ),
                                retry_config: retry_config.clone(),
                            })
                        })
...
#[cfg(test)]
mod tests {
    use super::monovertex::MonovertexConfig;
    use crate::config::common::sink::SinkType;
    use crate::config::common::source::SourceType;
    use crate::config::common::transformer::TransformerType;
    use crate::error::Error;
    use base64::prelude::BASE64_STANDARD;
    use base64::Engine;
    use std::env;

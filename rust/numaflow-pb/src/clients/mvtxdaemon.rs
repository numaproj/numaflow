...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct PersistRuntimeErrorRequest {
    #[prost(string, tag = "1")]
...
pub mod mono_vertex_daemon_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn persist_runtime_error(
            &mut self,
            request: impl tonic::IntoRequest<super::PersistRuntimeErrorRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PersistRuntimeErrorResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mvtxdaemon.MonoVertexDaemonService/PersistRuntimeError",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(

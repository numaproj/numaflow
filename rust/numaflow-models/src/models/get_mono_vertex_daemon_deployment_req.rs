...
impl GetMonoVertexDaemonDeploymentReq {
    pub fn new(default_resources: k8s_openapi::api::core::v1::ResourceRequirements, env: Vec<k8s_openapi::api::core::v1::EnvVar>, image: String, pull_policy: String) -> GetMonoVertexDaemonDeploymentReq {

...
impl ContainerType {
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            ContainerType::OnSuccessSinker => "on-success-sinker",
...
impl From<String> for ContainerType {
    fn from(s: String) -> Self {
        match s.as_str() {
            ...
            "on-success-sinker" => ContainerType::OnSuccessSinker,
...
mod version {
    ...
    static MINIMUM_SUPPORTED_SDK_VERSIONS: LazyLock<SdkConstraints> = LazyLock::new(|| {
        ...
        go_version_map.insert(ContainerType::OnSuccessSinker, "0.10.2-z".to_string());
        ...
        python_version_map.insert(ContainerType::OnSuccessSinker, "0.11.1rc100".to_string());
        ...
        java_version_map.insert(ContainerType::OnSuccessSinker, "0.10.2-z".to_string());

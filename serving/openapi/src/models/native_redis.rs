...
pub struct NativeRedis {
    ...
    #[serde(rename = "metricsContainerTemplate", skip_serializing_if = "Option::is_none")]
    pub metrics_container_template: Option<Box<models::ContainerTemplate>>,
    ...
    pub persistence: Option<Box<models::PersistenceStrategy>>,
    ...
    #[serde(rename = "redisContainerTemplate", skip_serializing_if = "Option::is_none")]
    pub redis_container_template: Option<Box<models::ContainerTemplate>>,
    ...
    pub sentinel_container_template: Option<Box<models::ContainerTemplate>>,
    ...
    pub settings: Option<Box<models::RedisSettings>>,

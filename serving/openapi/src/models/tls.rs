...
pub struct Tls {
    ...
    pub ca_cert_secret: Option<models::V1PeriodSecretKeySelector>,
    #[serde(rename = "certSecret", skip_serializing_if = "Option::is_none")]
    pub cert_secret: Option<models::V1PeriodSecretKeySelector>,
    ...
    pub key_secret: Option<models::V1PeriodSecretKeySelector>,
}

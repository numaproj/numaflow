...
pub struct InterStepBufferServiceList {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::InterStepBufferService>,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    #[serde(rename = "kind", skip_serializing_if = "Option::is_none")]
    pub kind: Option<String>,
    #[serde(rename = "metadata")]
    pub metadata: models::V1PeriodListMeta,
}

impl InterStepBufferServiceList {
    /// InterStepBufferServiceList is the list of InterStepBufferService resources
    pub fn new(items: Vec<models::InterStepBufferService>, metadata: models::V1PeriodListMeta) -> InterStepBufferServiceList {

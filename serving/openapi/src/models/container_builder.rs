...
pub struct ContainerBuilder {
    ...
    pub startup_probe: Option<crate::models::V1PeriodProbe>,
    ...
    pub volume_devices: Option<Vec<crate::models::V1PeriodVolumeDevice>>,

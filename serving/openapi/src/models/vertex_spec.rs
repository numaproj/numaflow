...
pub struct VertexSpec {
    ...
    pub affinity: Option<models::V1PeriodAffinity>,
    ...
    pub container_template: Option<Box<models::ContainerTemplate>>,
    #[serde(rename = "dnsConfig", skip_serializing_if = "Option::is_none")]
    pub dns_config: Option<models::V1PeriodPodDnsConfig>,
    ...
    #[serde(rename = "fromEdges", skip_serializing_if = "Option::is_none")]
    pub from_edges: Option<Vec<models::CombinedEdge>>,
    ...
    pub image_pull_secrets: Option<Vec<models::V1PeriodLocalObjectReference>>,
    #[serde(rename = "initContainerTemplate", skip_serializing_if = "Option::is_none")]
    pub init_container_template: Option<Box<models::ContainerTemplate>>,
    ...
    pub init_containers: Option<Vec<models::V1PeriodContainer>>,
    ...
    pub limits: Option<Box<models::VertexLimits>>,
    ...
    pub scale: Option<Box<models::Scale>>,
    #[serde(rename = "securityContext", skip_serializing_if = "Option::is_none")]
    pub security_context: Option<models::V1PeriodPodSecurityContext>,
    ...
    #[serde(rename = "sideInputsContainerTemplate", skip_serializing_if = "Option::is_none")]
    pub side_inputs_container_template: Option<Box<models::ContainerTemplate>>,
    /// List of customized sidecar containers belonging to the pod.
    #[serde(rename = "sidecars", skip_serializing_if = "Option::is_none")]
    pub sidecars: Option<Vec<models::V1PeriodContainer>>,
    #[serde(rename = "sink", skip_serializing_if = "Option::is_none")]
    pub sink: Option<Box<models::Sink>>,
    #[serde(rename = "source", skip_serializing_if = "Option::is_none")]
    pub source: Option<Box<models::Source>>,
    #[serde(rename = "toEdges", skip_serializing_if = "Option::is_none")]
    pub to_edges: Option<Vec<models::CombinedEdge>>,
    /// If specified, the pod's tolerations.
    #[serde(rename = "tolerations", skip_serializing_if = "Option::is_none")]
    pub tolerations: Option<Vec<models::V1PeriodToleration>>,
    #[serde(rename = "udf", skip_serializing_if = "Option::is_none")]
    pub udf: Option<Box<models::Udf>>,
...
impl VertexSpec {
    pub fn new(name: String, pipeline_name: String) -> VertexSpec {
        VertexSpec {
            affinity: None,

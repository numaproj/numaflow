# Rust API client for numaflow-client
...
Put the package under your project folder in a directory named `numaflow-client` and add the following to `Cargo.toml` under `[dependencies]`:

```
numaflow-client = { path = "./numaflow-client" }
```

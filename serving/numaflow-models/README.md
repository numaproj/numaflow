# Rust API client for numaflow-models
...
Put the package under your project folder in a directory named `numaflow-models` and add the following to `Cargo.toml` under `[dependencies]`:

...
func CreateAuthRouteMap(baseHref string) authz.RouteMap {
	return authz.RouteMap{
		...
		"GET:" + baseHref + "api/v1/namespaces/:namespace/pipelines/:pipeline/vertices/:vertex/replicas/:replica/errors": authz.NewRouteInfo(authz.ObjectPipeline, true),
		"GET:" + baseHref + "api/v1/namespaces/:namespace/mono-vertices/:mono-vertex/replicas/:replica/errors":           authz.NewRouteInfo(authz.ObjectMonoVertex, true),

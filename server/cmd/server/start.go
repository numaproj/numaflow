...
func CreateAuthRouteMap(baseHref string) authz.RouteMap {
	return authz.RouteMap{
		...
		"GET:" + baseHref + "api/v1/namespaces/:namespace/pipelines/:pipeline/isb/streams":                authz.NewRouteInfo(authz.ObjectPipeline, true),
		"GET:" + baseHref + "api/v1/namespaces/:namespace/pipelines/:pipeline/isb/consumers":              authz.NewRouteInfo(authz.ObjectPipeline, true),
		"GET:" + baseHref + "api/v1/namespaces/:namespace/pipelines/:pipeline/isb/kv-stores":              authz.NewRouteInfo(authz.ObjectPipeline, true),
		...
		"GET:" + baseHref + "api/v1/namespaces/:namespace/pipelines/:pipeline/vertices/:vertex/errors":    authz.NewRouteInfo(authz.ObjectPipeline, true),

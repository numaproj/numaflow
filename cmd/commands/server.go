...
func NewServerCommand() *cobra.Command {
	...
	command.Flags().StringSliceVar(&allowedHost, "allowed-host", strings.Split(sharedutil.LookupEnvStringOr("NUMAFLOW_SERVER_ALLOWED_HOST", ""), "https://localhost:8443"), "List of allowed host for enabled CORS, defaults to true.")

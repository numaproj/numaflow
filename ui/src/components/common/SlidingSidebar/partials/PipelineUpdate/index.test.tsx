...
import { PipelineUpdate } from "./index";
...
describe("PipelineUpdate", () => {
  ...
  //     expect(
  //       screen.getByText(
  //         `{"submit":{"status":1,"message":"Pipeline update submitted successfully","allowRetry":false},"processing":{"status":1,"message":"Pipeline updated successfully"}}`
  //       )
  //     ).toBeInTheDocument();
  //   });

...
export const SOURCE_TRANSFORMER_PROCESSING_TIME_LATENCY = "Source Transformer Processing Time Latency";
export const FALLBACK_SINK_WRITE_TIME_LATENCY = "Fallback Sink Write Time Latency";
...
export const MONO_VERTEX_FALLBACK_SINK_WRITE_TIME_LATENCY = "MonoVertex Fallback Sink Write Time Latency";

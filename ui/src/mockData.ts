export const SAMPLE_NAMESPACES = ["dataflow-system"];
    ...
    metadata: {
      ...
      annotations: {
        "kubectl.kubernetes.io/last-applied-configuration":
          '{"apiVersion":"dataflow.ossanalytics.io/v1alpha1","kind":"Pipeline","metadata":{"annotations":{},"name":"simple-pipeline","namespace":"dataflow-system"},"spec":{"edges":[{"from":"input","to":"cat"},{"from":"cat","to":"output"}],"vertices":[{"name":"input","source":{"generator":{"duration":"1s","rpu":5}}},{"name":"cat","udf":{"builtin":{"name":"cat"}}},{"name":"output","sink":{"log":{}}}]}}\n',
      },

...
ifeq ($(shell uname),Darwin)
	...
	curl -sSfL https://github.com/lycheeverse/lychee/releases/download/lychee-v0.24.2/lychee-$(shell uname -m)-unknown-linux-gnu.tar.gz | sudo tar xz -C /usr/local/bin/
endif
endif
